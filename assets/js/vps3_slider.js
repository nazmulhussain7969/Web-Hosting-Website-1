...
var cpu_arr = new Array('1.4 GHZ', '2.4 GHZ', '3.4 GHZ', '4.4 GHZ', '5.4 GHZ', '6.4 GHZ');
var space_arr = new Array('12GB', '16GB', '20GB', '240GB', '280GB', '32GB');
var connection_arr = new Array('01', '03', '06', '09', '12', '15');
var data_arr = new Array('1TB', '2TB', '3TB', '4TB', '5TB', '6TB');
var tracfficdata_arr = new Array('20GB', '22GB', '24GB', '26GB', '28GB', '25GB');
var backupdata_arr = new Array('$09/mo', '$19/mo', '$29/mo', '$39/mo', '$49/mo', '$59/mo');
...
$(document).ready(function () {
    ...
    function initializeSlider() {
        ...
        $("#home3slider").slider({
            ...
            slide: function (event, ui) {
                ...
                $(".home3slider-container div.price_rangetxt div#icon-" + (ui.value - 1)).addClass("current");
            },
    ...
    $('.icon').click(function () {
        // Remove 'current' class from all icons
        $(".home3slider-container div.price_rangetxt div").removeClass("current");

        // Get the clicked icon's value
        let ch_value = parseInt(this.id.slice(5)) + 1;

        // Add 'current' class to the clicked icon
